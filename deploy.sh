...
if [ -f "$ENV_FILE" ]; then
  ...
  echo "   DATABASE_URL=postgresql://anchatbot:e4857209f4d13149c873b05161ef@localhost:5432/anchatbot"
  echo "   ADMIN_ID=277236314"
  echo ""
  exit 1
fi
...
echo "🗃️  در حال بررسی و آپدیت دیتابیس..."
